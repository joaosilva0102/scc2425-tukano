...
public interface Shorts {
	 ...
	 */
	utils.Result<Short> createShort(String userId, String password);
	 ...
	 * 	FORBIDDEN, if the password is not correct;
	 */
	utils.Result<Void> deleteShort(String shortId, String password, NewCookie cookie);
	 ...
	 * 	NOT_FOUND if shortId does not match an existing short
	 */
	utils.Result<Short> getShort(String shortId);
	 ...
	 */
	utils.Result<List<String>> getShorts(String userId );
	 ...
	 */
	utils.Result<Void> follow(String userId1, String userId2, boolean isFollowing, String password);
	 ...
	 * FORBIDDEN if the password is incorrect
	 */
	utils.Result<List<String>> followers(String userId, String password);
	/**
	 ...
	 *  BAD_REQUEST, otherwise
	 */
	utils.Result<Void> like(String shortId, String userId, boolean isLiked, String password);
	 ...
	 * FORBIDDEN if the password is incorrect
	 */
	utils.Result<List<String>> likes(String shortId, String password);
	 ...
	 *  FORBIDDEN if the password is incorrect
	 */
	utils.Result<List<String>> getFeed(String userId, String password);
