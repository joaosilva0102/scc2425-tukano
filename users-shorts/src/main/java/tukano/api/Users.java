...
public interface Users {
	 ...
	 */
	utils.Result<String> createUser(User user);
	 ...
	 */
	utils.Result<User> getUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	utils.Result<User> updateUser(String userId, String pwd, User user);
