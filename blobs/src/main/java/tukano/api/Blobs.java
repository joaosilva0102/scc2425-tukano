...
public interface Blobs {
	 ...
	 */
	utils.Result<Void> upload(String blobId, byte[] bytes, String token);
	 ...
	 */
	utils.Result<byte[]> download(String blobId, String token);
	 ...
	 * 			 NOT_FOUND, if no blob matches the provided blobId
	 */
	utils.Result<Void> delete(String blobId, String token );
