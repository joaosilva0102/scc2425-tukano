...
public class JavaShorts implements Shorts {
    ...
    private Result<Object> callFunctionTukanoRecommends() {
        String base_url = System.getProperty("FUNCTIONS_RECOMMENDATIONS_URL");
        String url = String.format("%s%s", base_url, "/recommends");
        try {
