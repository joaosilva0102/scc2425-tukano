...
public class CosmosDBLayer_SingleContainer {
    ...
    private static CosmosDBLayer_SingleContainer instance;

    public static synchronized CosmosDBLayer_SingleContainer getInstance() {
        if (instance != null)
            return instance;
        ...
        CosmosClient client = new CosmosClientBuilder()
                ...
                .buildClient();
        instance = new CosmosDBLayer_SingleContainer(client);
        return instance;
    }
    ...
    public CosmosDBLayer_SingleContainer(CosmosClient client) {
        this.client = client;
    }
